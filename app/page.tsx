...
export default function Home() {
  ...
  <div className="absolute inset-0 bg-yellow-50 dark:bg-[#1A1A1A] -z-10" />
  <div className="container px-4 md:px-6">
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
      ...
      <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden shadow-xl">
        ...
        {/* Features Section */}
        <section id="features" className="py-20 bg-[#1A1A1A] text-white">
  <div className="container px-4 md:px-6">
...
<section id="use-cases" className="py-20 bg-[#1A1A1A] text-white">
  <div className="container px-4 md:px-6">
    <div className="text-center mb-12">
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        Industry Use Cases
    ...
    <div className="mt-16">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="h-12 w-32 bg-[#1A1A1A] rounded-md flex items-center justify-center"
          >
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          <div className="text-center">
            <h3 className="text-3xl font-bold text-[#FB930B]">50+</h3>
            <p className="text-sm text-[#E0E0E0]">Engineers</p>
          </div>
          <div className="text-center">
            <h3 className="text-3xl font-bold text-[#FB930B]">100+</h3>
            <p className="text-sm text-[#E0E0E0]">Deployments</p>
          </div>
          <div className="text-center">
            <h3 className="text-3xl font-bold text-[#FB930B]">12</h3>
...
<section id="contact" className="py-20 bg-[#000000] text-white">
  <div className="container px-4 md:px-6">
    <div className="grid lg:grid-cols-2 gap-12">
      {/* Left Text Block */}
      <div className="space-y-6">
        <h2 className="text-3xl md:text-4xl font-bold text-[#FB930B]">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-[#1A1A1A] flex items-center justify-center">
              <Users className="h-5 w-5 text-[#FB930B]" />
            </div>
            <div>
              <h3 className="font-medium text-[#FB930B]">Sales Team</h3>
              <p className="text-sm text-[#E0E0E0]">sales@sasha.tech</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-[#1A1A1A] flex items-center justify-center">
              <Headphones className="h-5 w-5 text-[#FB930B]" />
            </div>
            <div>
              <h3 className="font-medium text-[#FB930B]">Support</h3>
      ...
      {/* Right Contact Form */}
      <Card className="bg-[#1A1A1A] text-white shadow-lg border border-[#333333]">
        <CardHeader>
          <CardTitle className="text-[#FB930B]">Contact Us</CardTitle>
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="first-name" className="bg-[#000000] text-white border border-[#444]" />
              </div>
              <div className="space-y-2">
                <label htmlFor="last-name" className="text-sm font-medium text-[#E0E0E0]">
                  Last Name
                </label>
                <Input id="last-name" className="bg-[#000000] text-white border border-[#444]" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="robert@example.com" className="bg-[#000000] text-white border border-[#444]" />
            </div>
            <div className="space-y-2">
              <label htmlFor="company" className="text-sm font-medium text-[#E0E0E0]">
                Company
              </label>
              <Input id="company" placeholder="Your company" className="bg-[#000000] text-white border border-[#444]" />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-[#000000] text-white border border-[#444]"
              />
            </div>
            <Button className="w-full bg-[#FB930B] hover:bg-[#FB930B]/80 text-black">
              Send Message
            </Button>
          </form>
        </CardContent>
      ...
      {/* Footer */}
      {/* Footer */}
<footer className="border-t border-[#333] py-12 bg-[#1A1A1A] text-white">
  <div className="container px-4 md:px-6">
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
      <div className="space-y-2 md:space-y-4">
        <div>
          ...
          <div className="flex md:items-center gap-2 text-left">
            ...
            />
            <span className="font-bold text-[#FB930B]">SASHA INNOWORKS</span>
          </div>
        </div>
        <p className="text-sm text-[#E0E0E0]">
      ...
      <div>
        <h3 className="font-medium mb-4 text-[#FB930B]">Product</h3>
        <ul className="space-y-2 text-sm">
          {["Features", "Pricing", "Documentation", "API"].map((item, i) => (
            <li key={i}>
              <Link href="#" className="text-[#E0E0E0] hover:text-[#FB930B]">
                {item}
              </Link>
            </li>
          ))}
      ...
      <div>
        <h3 className="font-medium mb-4 text-[#FB930B]">Company</h3>
        <ul className="space-y-2 text-sm">
      ...
      <div>
        <h3 className="font-medium mb-4 text-[#FB930B]">Legal</h3>
        <ul className="space-y-2 text-sm">
